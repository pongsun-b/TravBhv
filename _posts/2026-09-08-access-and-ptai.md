...
Use the map when the question is first-mile walking. Use PTAI (on request, with a name and an intended use) when the question is generalized cost across modes. Method for the map: [Walk access to urban rail]({{ site.baseurl }}{% post_url 2026-09-08-walk-access-map %}).
